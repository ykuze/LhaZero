...
/* functions declared */
#if WIN32
static void count_t_freq P((void));
static void write_pt_len P((short n, short nbit, short i_special));
static void write_c_len P((void));
static void encode_c P((short c));
static void encode_p P((unsigned short p));
static void send_block P((void));
static void read_pt_len P((short nn, short nbit, short i_special));
static void read_c_len P((void));
#endif /* WIN32 */
/* ------------------------------------------------------------------------ */
/*								Encording									*/
/* ------------------------------------------------------------------------ */
