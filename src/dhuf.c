...
/* functions declared */
#if WIN32
static void start_p_dyn P((void));
static void reconst P((int start, int end));
static int swap_inc P((int p));
static void update_c P((int p));
static void update_p P((int p));
static void make_new_node P((int p));
static void encode_c_dyn P((unsigned int c));
#endif /* WIN32 */
/* ------------------------------------------------------------------------ */
void
start_c_dyn( /* void */ )
