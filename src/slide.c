...
/* functions declared */
#if WIN32
static void init_slide P((void));
static void update P((void));
static void insert P((void));
static void match_insert P((void));
static void get_next P((void));
#endif /* WIN32 */
/* ------------------------------------------------------------------------ */
...
static struct encode_option encode_define[2] = {
	...
	/* lh1 */
	{(void (*) ()) output_dyn,
		(void (*) P((void))) encode_start_fix,
	(void (*) P((void))) encode_end_dyn},
	/* lh4, 5,6 */
	{(void (*) ()) output_st1,
		(void (*) P((void))) encode_start_st1,
	(void (*) P((void))) encode_end_st1}
#else
	/* lh1 */
	{(int (*) ()) output_dyn,
